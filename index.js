...
const config = {
    A187: '✞❐͜͡𝑲𝑰𝑹𝑰𝑻𝒪🌹',
    instagram: 'https://www.instagram.com/invites/contact/?i=1uv0pvak9cnyf&utm_content=isi2ka8',
    nomer: 'wa.me/5593991782858',
    aktif: '24 JAM',
    youtube: 'https://youtube.com/channel/UCokTbyiYDTHxWxvoxmfldeg',
...
client.on('message-status-update', json => {
   ...
   console.log(`[ ${time} ] => bot by ig:@kiritoxis`)
})
